...
void app_main(void)
{
    ...
    xTaskCreate(liusu_task, "liusu_task", 4096, NULL, 5, NULL);
    // gpio_init_s(GPIO_NUM_6, GPIO_MODE_INPUT);

    while (1)
    {
        // ESP_LOGI("water_task", "water_task");
        //
        // set_chongshua_sudu(0);
        // vTaskDelay(500 / portTICK_PERIOD_MS);
        //
        //
        // set_rudongbeng_sudo(100);
        //
        // vTaskDelay(500 / portTICK_PERIOD_MS);
        //
        // set_chongshua_sudu(80);
        // vTaskDelay(500 / portTICK_PERIOD_MS);
        //
        // set_rudongbeng_sudo(0);
        // int level = gpio_get_level_s(GPIO_NUM_6);
        // ESP_LOGI("water_task", "water_task %d", level);
